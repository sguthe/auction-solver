...
namespace auction
{
  ...
  __forceinline void heap_upheap(KC &key, VC &value, int k, K v_key, V v_value)
  {
    int j = (k - 1) >> 1;
  ...
  template <class KC, class VC, class K, class V>
  __forceinline void heap_downheap(KC &key, VC &value, int N, int k, K v_key, V v_value)
  {
    int j = (k << 1) + 1;
    while (j < N)
    {
  ...
  template <class KC, class VC, class K, class V>
  __forceinline void heap_replace(KC &key, VC &value, int N, K v_key, V v_value)
  {
  ...
  template <class KC, class VC, class K, class V>
  __forceinline void heap_insert(KC &key, VC &value, int &N, K v_key, V v_value)
  {
    N++;
  ...
  template <class KC, class VC, class K, class V>
  __forceinline void heap_pop(KC &key, VC &value, int &N)
  {
    N--;
  ...
  template <class KC, class VC, class K, class V>
  __forceinline void heap_sort(KC &key, VC &value, int N)
  {
    while (N > 1)
    {
      N--;
